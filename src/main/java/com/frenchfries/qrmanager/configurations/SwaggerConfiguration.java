package com.frenchfries.qrmanager.configurations;
...
public class SwaggerConfiguration {
	...
	public Docket swaggerConf() {
		return new Docket(DocumentationType.SWAGGER_2).select().apis(RequestHandlerSelectors.any())
				.paths(PathSelectors.regex("/qr-.*")).build().useDefaultResponseMessages(false);
	}

	@SuppressWarnings("deprecation")
	private ApiInfo apiInfo() {
		return new ApiInfo("QR-Manager",
				"Microservice to generate avd validate QR",
				"1.0", null, "French Fries", null, null);
	}
